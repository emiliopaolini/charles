...
using uint6_t = number<cpp_int_backend<6, 6, unsigned_magnitude, unchecked, void> >  ;
...
using int6_t = number<cpp_int_backend<6, 6, signed_magnitude, unchecked, void> >  ;
using int14_t = number<cpp_int_backend<14, 14, signed_magnitude, unchecked, void> >  ;
using boost_int16_t = number<cpp_int_backend<16, 16, signed_magnitude, unchecked, void> >  ;
using int15_t = number<cpp_int_backend<15, 15, signed_magnitude, unchecked, void> >  ;
